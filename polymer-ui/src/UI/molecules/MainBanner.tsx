        ...
        bannerPaths.includes(match.path) && (
          <Box sx={styles.banner}>
            <Box sx={styles.article}>
              <Typography color='white' sx={styles.title} variant='h3'>
                {banner[match.path].title}
              </Typography>
              <Typography color='white' sx={styles.text} variant='h6'>
                {banner[match.path].text}
              </Typography>
            </Box>
            <Box sx={styles.blackout}></Box>
            <img alt={banner[match.path].title} src={banner[match.path].image} />
          </Box>
        )
      )}
    </Box>
